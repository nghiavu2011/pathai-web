...
const GuideModal: React.FC<GuideModalProps> = ({ onClose }) => {
  ...
  const steps = [
    ...
    },
    {
      ...
      title: "2. Nhận kết quả & Tham vấn AI",
      description: "Xem báo cáo chi tiết, trực quan ngay sau khi hoàn thành. Trợ lý AI Tham vấn sẽ hỗ trợ giải thích kết quả và gợi ý hướng đi học tập, rèn luyện dành riêng cho bạn."
    },
    {
      icon: (
