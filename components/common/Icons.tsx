...
export const TikTokIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg fill="currentColor" viewBox="0 0 24 24" className={className}>
    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v6.16c0 2.52-1.12 4.84-2.9 6.24-2.22 1.71-5.27 1.72-7.54.09-2.33-1.69-3.14-4.85-1.84-7.41 1.23-2.44 4.05-3.62 6.6-2.79v4.16c-1.3-.37-2.63.22-3.23 1.39-.61 1.17-.06 2.64 1.19 3.23 1.26.59 2.74.05 3.33-1.21.12-.26.18-.54.18-.82V.02h.13z" />
  </svg>
);
